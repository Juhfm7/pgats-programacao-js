...
const sexo = 'Fêmea'
const cor = 'Caramela'
const dataDeNascimento = '20/04/2015'
const porte = 'F'
...
/*
console.log(irmaos)
var irmaos = ["Simba", "Madruga"]
*/
 
/*
const irmaos = ["Simba", "Madruga"]
...
const nomesDeAlunos = "Juliana Marjorie Ana Maria Pedro"
const nomesDeAlunosSplit = nomesDeAlunos.split(" ") // separa a string em um array de substrings com base no espaço em branco
 
console.log(nomesDeAlunosSplit) // ["Juliana", "Marjorie", "Ana", "Maria", "Pedro"]
 
console.log(nomesDeAlunos.toLowerCase()) // ["juliana", "marjorie", "ana", "maria", "pedro"] - transforma tudo em minúsculo
console.log(nomesDeAlunos.toUpperCase()) // ["JULIANA", "MARJORIE", "ANA", "MARIA", "PEDRO"] - transforma tudo em maiúsculo
...
console.log(nomesDeAlunos.replaceAll('a', 'i')) // ["Julijina", "Mijjorie", "Ana", "Mijri", "Pedro"] - substitui todas as ocorrências de 'a' por 'i'
console.log(nomesDeAlunos.replace('a', 'i')) // ["Julijina", "Mijjorie", "Ana", "Mijri", "Pedro"] - substitui a primeira ocorrência de 'a' por 'i'
